 ...
 * data structure.
 */
public class StinglyLinkedList<E> {
    ...
    public StinglyLinkedList(){}   // construcst an initially empty list.
   ...
   {
       if(!(o instanceof StinglyLinkedList))
           return false;
       StinglyLinkedList l = (StinglyLinkedList) o;
       if (size != l.size())
           return false;
